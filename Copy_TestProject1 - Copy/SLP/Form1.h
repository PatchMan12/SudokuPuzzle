...
namespace SLP {
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->SudokuPanel->Size = System::Drawing::Size(415, 415);
			...
			// SOLVEBUTTON
			// 
			this->SOLVEBUTTON->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(224)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
	...
	private:
		System::Void SOLVEBUTTON_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			{
				MessageBox::Show("Error: Duplicate inputs are not valid!", "Invalid Input", MessageBoxButtons::OK, MessageBoxIcon::Error);
				return;
			}
